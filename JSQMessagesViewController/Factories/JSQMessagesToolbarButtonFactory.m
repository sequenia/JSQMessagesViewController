...
{
    return [self defaultAccessoryButtonItemWithColor:[UIColor lightGrayColor] highlightedColor:[UIColor darkGrayColor]];
}
...
- (UIButton *)defaultAccessoryButtonItemWithColor:(UIColor *)color highlightedColor:(UIColor *)highlightedColor {
    ...
    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:color];
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:highlightedColor];
...
{
    return [self defaultSendButtonItemWithColor:[UIColor jsq_messageBubbleBlueColor]
                               highlightedColor:[[UIColor jsq_messageBubbleBlueColor] jsq_colorByDarkeningColorWithValue:0.1f]
...
- (UIButton *)defaultSendButtonItemWithColor:(UIColor *)color highlightedColor:(UIColor *)highlightedColor disabledColor:(UIColor *)disabledColor
{
    ...
    [sendButton setTitleColor:highlightedColor forState:UIControlStateHighlighted];
    [sendButton setTitleColor:disabledColor forState:UIControlStateDisabled];
