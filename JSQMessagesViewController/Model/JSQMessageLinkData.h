 ...
 */
@protocol JSQMessageLinkData <NSObject>
 ...
 */
- (nullable UIView *)linkView;

- (nullable UIImageView *) linkQuotedView;
...
@property (copy, nonatomic, readwrite) NSString* linkViewTitle;
